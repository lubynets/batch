...
# SETUP_IN=apr20_fr_18.2.1_fs_jun19p1/${EVENT_GEN}_pluto_etap/auau/12agev/mbias/sis100_electron_target_25_mkm/TGeant4 #    2001-3000
...
# 
# SETUP_OUT=apr20_fr_18.2.1_fs_jun19p1/${EVENT_GEN}_pluto/auau/12agev/mbias/sis100_electron_target_25_mkm
# #----------------------------------------------------------------------------------------------------------------------------------------
...
OUTPUT_DIR=${PROJECT_DIR}/outputs/$SETUP_OUT/AT2
