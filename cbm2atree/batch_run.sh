...
CBMROOT=/u/lubynets/soft/cbmrootmaster/install
...
OUTPUT_DIR=${PROJECT_DIR}/outputs_APR21_at2/test_prod_AT/urqmd/auau/12agev/mbias/TGeant3
...
root -l -b -q "${MACRO}(\"/lustre/cbm/users/klochkov/cbm/test_prod_AT/urqmd/auau/12agev/mbias/TGeant3/\", \"${INDEX}\")" >& log_${INDEX}.txt
