...
SOFT_DIR=/lustre/cbm/users/lubynets/soft/pid/install_brex
...
INPUT_DIR=/lustre/cbm/users/lubynets/cbm2atree/outputs/$SETUP_SIM/AT_brex
OUTPUT_DIR=$PROJECT_DIR/outputs/$SETUP_SIM/decay$PDG
...
PID_FILE=$PROJECT_DIR/getters/pid_getter.apr20.dcmqgsm.12agev.decay$PDG.root

ls -d $INPUT_DIR/$INDEX.analysistree.root > filelist.list
