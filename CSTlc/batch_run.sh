...
JSON_FILE=$CONFIG_DIR/dpl-config_CSTlc_$MC_OR_DATA.$INDEX.json
if [[ $RUN_MODE = "greatRun" ]]; then
#   INPUT_FILE=$INPUT_DIR/AnalysisResults_trees.1.root
  INPUT_FILE=/lustre/alice/users/lubynets/ao2ds/sim/2024/LHC24e3/0/526641/AOD/001/AnalysisResults_skimmed.root
  OUTPUT_DIR=$PROJECT_DIR/outputs/$MC_OR_DATA/$SKIM_SELECTION/$SIG_BG/$CONSTRAINT/mod$INDEX
